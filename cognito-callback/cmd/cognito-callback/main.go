...
func getCognitoConfig() cognitoConfig {
	...
	c := new(cognitoConfig)
	c.cognitoClientId = "4udd2efhc7b93nnq2ianoncocj"
	c.cognitoClientSecret = "qinbf0sgkq066ld2tfvdps77rmnnsa9mfhicbkudns848tu40sl"
	c.cognitoDnsPoll = "fiap-grupo36"
	c.awsRegion = "us-east-1"
	c.apiGatewayPrefix = "nscdo8w4l9"
	c.apiStage = "default"
